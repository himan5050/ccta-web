				...
				<h4>
					...
					<span> <a
						href="<?php echo site_url('project'); ?>" class="active" id="">Project
							Info</a> <a
						href="<?php echo site_url('project_funds'); ?>" id="">Funds</a>
						<a
						href="<?php echo site_url('project_phase_contract'); ?>" id="">Phase
							to Contract Mapping</a> <a
						href="<?php echo site_url('financial_plan'); ?>" id="">Financial
							Plan</a> <a href="<?php echo site_url('report1'); ?>" id="">Report
							1</a> <a href="<?php echo site_url('report2'); ?>" id="">Report 2</a>
						<a href="<?php echo site_url('report3'); ?>" id="">Report 3</a> </span>
				</h4>
			</div>
			<div class="body_content">
				<div class="panel panel-default" id="">
					...
					<div class="panel-body">
						<div class="row">
								<form method="post" id="project_form" class="form-horizontal"
									action="">
									<div class="col-sm-1">
										<div class="form-group">
											...
											<div class="col-sm-12">
												<input type="text" name="project_code" class="form-control"
													id="" placeholder="Enter Project Code" required="required"
													value="<?php echo !empty($post['project_code'])?$post['project_code']:''; ?>">
											</div>
										</div>
									</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-12">
												<input type="text" name="project_name" class="form-control"
													id="" placeholder="Enter Project Name" required="required"
													value="<?php echo !empty($post['project_name'])?$post['project_name']:''; ?>"
													readonly="readonly">
											</div>
										</div>
									</div>
									...
									<div class="col-sm-2">
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="total_project_cost" class="form-control number" id="total_project_cost" value="<?php echo !empty($post['total_project_cost'])?$post['total_project_cost']:''; ?>" placeholder="0" required="required" onblur="change(0)">
											</div>
										</div>
									</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type='text' name="start_date" class="form-control"
													...
													value="<?php echo !empty($post['start_date'])?$post['start_date']:''; ?>">
											</div>
										</div>
									</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type='text' name="end_date" class="form-control"
													...
													value="<?php echo !empty($post['end_date'])?$post['end_date']:''; ?>">
											</div>
										</div>
									</div>
    ...
    $.ajax(
      {
        ...
        success:function(response)
        {
          ...
          { var html = "";
            ...
            {
              html += '<tr><td>'+ response[i]['project_name'] +'</td><td>'+ response[i]['description'] +'</td><td>'+ response[i]['start_date'] +'</td><td>'+ response[i]['end_date'] +'</td><td>'+ response[i]['date_added'] +'</td></tr>';
            }
