    <div class="container-fluid main_content_body" id="main-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <form class="form-horizontal" action="" method="post" enctype="multipart/form-data" >
                        ...
                        <div class="col-md-1">
                          <div class="form-group">
                            <label class="col-sm-8" for="">Contract:</label>
                            <div class="col-sm-12">
                              <input type="text" class="form-control contract" id="contract0" placeholder="" name="contract[]" onblur="check(this)">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-1">
                          <div class="form-group">
                            ...
                            <div class="col-sm-12">
                              <input type="text" required class="form-control contract" id="amount0" placeholder="" name="amount[]" onblur="check(this)" required="required">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-1">
                          <div class="form-group">
                            ...
                            <div class="col-sm-12">
                              <input type="file" name="attachment[]" class="form-control" id="" placeholder="">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-1">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <div class="row">
                    <div class="col-md-12">
                      <table id="dataTable_exp_0" class="table table-striped">
                        <thead>
                          <tr>
                            <th>Phase Name</th>
                            <th>Contract</th>
                          ...
                          <tfoot>
                            ...
                            <tr>
                              ...
                              <td><b>$ <?php echo number_format(preg_replace('/\s+/', '', $remaining_amount), 0) ?></b></td>
                              <td></td>
                              <td></td>
                              <td></td>
                            </tr>
  ...
  $(document).ready(function() {
    var table = $("#dataTable_exp_0").dataTable({"ordering": false});
    ...
    var dt_filter = '<div class="col-md-8" style="padding:0;"><form class="form-horizontal" action="" method="post" id="formfilters">'+
            ...
            '<div class="col-md-2"><input type="submit" name="postFilter" class="btn btn-sm btn-success" value="Apply"/></form></div>'+
              ...
              '</div>';
    $('#dataTable_exp_0_wrapper').find(".row").eq(0).find(".col-sm-2").eq(0).after(dt_filter);
    $('#dataTable_exp_0_wrapper').find(".row").eq(0).css("margin-bottom", "10px");
...
<script type="text/javascript">
  function check(i)
  {
    ...
    var y = $("#"+z).parent().parent().parent().parent().find(".phase").val();

    if(x && y)
    {
      $.ajax(
        {
          url: "<?php echo site_url(); ?>/project_phase_contract/check",
          type:"post",
          dataType:"json",
          data:{ contract_name : x, phase_id : y  },
          success:function(response)
          {
            if(response == 1)
            {
    ...
    /*else
    {
      alert("Select Phase Name first");
      $("#"+z).val("");
    }*/

    if(x)
    {
      var phases = document.getElementsByName("phase_id[]");

      var contracts = document.getElementsByName("contract_name[]");

      for(var i=0; i<phases.length; i++)
      {
        for (var j = 0; j < phases.length; j++)
        {
          var cmp1 = parseInt(phases[i].value);
          var cmp2 = contracts[i].value;

          var cmp3 = parseInt(phases[j].value);
          var cmp4 = contracts[j].value;
          ...
          if (i != j)
          {
            if(cmp1 == cmp3)
            {
              if(cmp2 == cmp4)
              {
                alert("Can't enter duplicate Phase to Contract");
                $("#"+z).val("");
              }
            }
          }
...
<script type="text/javascript">
  function check1(i)
  {
    ...
    var y = $("#"+z).parent().parent().parent().parent().find(".contract").val();
      ...
      $.ajax(
        {
          ...
          type:"post",
          dataType:"json",
          data:{ contract_name : y, phase_id : x  },
          success:function(response)
          {
            if(response == 1)
            {
